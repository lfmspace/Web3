...
/// custom:halmos1 --solver z3 --loop 2 --solver-timeout-assertion 0
contract RTRentMarketHalmosTest is SymTest, Test {
    RTNFT public nft;
     ...
     */
    function check_testBorrow_willSucceed_stateUnkow(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        //获取tokenMaker签名
     ...
     */
    function check_testBorrow_willSucceed_stateRedeemed(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        check_testTakerRedeem_willSucceed(dailyRent, rentalDuration, collateral, callValue);
        check_testBorrow_willSucceed_stateUnkow(dailyRent, rentalDuration, collateral, callValue);
    }
     ...
     */
    function check_testBorrow_willSucceed_stateMakerClear(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        check_testMakerClear_willSucceed(dailyRent, rentalDuration, collateral, callValue);
     ...
     **/
    function check_testTakerRedeem_willSucceed(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        check_testBorrow_willSucceed_stateUnkow(dailyRent, rentalDuration, collateral, callValue);
     ...
     **/
    function check_testTakerRedeem_willSucceed_timeoutLess100Days(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        // dailyRent = 1;
     ...
     **/
    function check_testTakerRedeem_willSucceed_timeoutGreater100Days(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        //限制超期大于100天；
        uint256 overDays = vm.randomUint();
     ...
     **/
    function check_testMakerClear_willSucceed(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        //设置超时超过12天
        uint256 overDays = vm.randomUint();
     ...
     */
    function check_testSignatureCancel_willSucceed(uint8 v, bytes32 r, bytes32 s) public {
        // vm.expectEmit(false, false, false, true);
     ...
     * WillSucceed分支：租金大于0
     */
    function check_testMakerClaim_willSucceed(uint256 dailyRent, uint256 rentalDuration, uint96 collateral, uint96 callValue) public assumeOverflow(dailyRent, rentalDuration, collateral, callValue) {
        check_testBorrow_willSucceed_stateUnkow(dailyRent, rentalDuration, collateral, callValue);
