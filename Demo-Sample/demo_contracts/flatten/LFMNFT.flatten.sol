...
pragma solidity <0.9.0 =0.8.25 >=0.4.16 >=0.4.22 >=0.5.0 >=0.6.0 >=0.6.2 >=0.8.4 ^0.8.20;
...
// src/NFTRent/LFMNFT.sol

contract LFMNFT is ERC721, ERC721URIStorage, EIP712, Nonces, Ownable {
    ...
    constructor(
        address owner
    ) ERC721('LFMNFT', 'LFT') EIP712('LFMNFT', '1') Nonces() Ownable(owner) {}
