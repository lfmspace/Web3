...
contract LNFT721Market{
  LNFT721 public _nft;
  LToken public _token;

mapping(uint256=>uint256) public _prices;
//  constructor(address nftAddr,address token) {
//   _nft=LNFT721(nftAddr);
//   _token=LToken(nftAddr);
//  }
   
// function list(address tokenId,uint256 amount) public returns(bool){
